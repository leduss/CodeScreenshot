...
export const translations: Record<Locale, TranslationKeys> = {
  fr: {
    ...
    exportSharePostText: 'Capture {name} — créée avec Snipforge',
  ...
  en: {
    ...
    exportSharePostText: 'Snippet {name} — created with Snipforge',
  ...
  es: {
    ...
    exportSharePostText: 'Captura {name} — creada con Snipforge',
  ...
  de: {
    ...
    exportSharePostText: 'Snippet {name} — erstellt mit Snipforge',
  ...
  it: {
    ...
    exportSharePostText: 'Snippet {name} — creato con Snipforge',
  ...
  pt: {
    ...
    exportSharePostText: 'Snippet {name} — criado com Snipforge',
